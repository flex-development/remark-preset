...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/remark-preset
   cd remark-preset
   ```
...
```sh
https://github.com/flex-development/remark-preset/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/remark-preset/discussions/new?category=q-a
